          ...
          <div id="business_container_first">
            <div id="digital_wrapper">
                ...
                <div id="digital_explain01">
                    ...
                    <p>データ分析に基づいて、最適で実現可能なデジタル戦略を策定します。</p>
                </div>

                <div id="digital_explain02">
                    <img class="check_mark" src="<?php echo get_template_directory_uri();?>/images/check-mark.png">
                    <p>デジタル技術を活用した新規事業の企画、既存事業のデジタル化も支援します。</p>
                </div>
            </div>
          ...
          <div id="business_container_second">
            <div id="seminar_wrapper">
                ...
                <div id="seminar_explain01">
                    <img class="check_mark" src="<?php echo get_template_directory_uri();?>/images/check-mark.png">
                    <p>ITスキルや経営スキルなど、必要な人材を育成する研修プログラムを提供します。</p>
                </div>

                <div id="seminar_explain02">
                    <img class="check_mark" src="<?php echo get_template_directory_uri();?>/images/check-mark.png">
                    <p>企業のニーズに合わせたオーダーメイド研修を実施します。</p>
                </div>
            </div>
        ...
        <section id="advantage">
          ...
          <div id="advantage_container">  
            <div id="item_01">
              ...
              <p>特定の業界に特化したソリューションを提供することで、課題解決の迅速化を実現。</p>
              <p>豊富な経験とノウハウに基づいた最適な提案で、業務効率を大幅に向上させ、顧客満足度向上に貢献。</p>
            </div>
        ...
        <section id="news">
          ...
          <div id="news-container">
            <div id="news-item">
                ...
                ?>      
                <span id="news_and_info_category" class="<?php echo $class_name; ?>">
                  <?php
                    if ( ! empty( $categories ) ) {
